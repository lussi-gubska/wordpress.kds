 ...
 */
class PenciTextToSpeechCustomizer {
	/**
	 * @var Customizer
	 */
	 ...
	 * @var string
	 */
	private static $package = 'PenciTextToSpeech';
	...
	private $list_section = array(
		...
		'penci_texttospeech_voice_section',
	);
	...
	public function load_customizer() {
		...
		new Customizer\Penci_TextToSpeech_Option( $this->customizer, 205 );
	}
}
