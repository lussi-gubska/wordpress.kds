...
class PenciPaywallCustomizer {
	 ...
	 * @var string
	 */
	private static $package = 'PenciPaywall';
	...
	private $list_section = array(
		'penci_paywall_general_section',
		'penci_paywall_advanced_section',
		'penci_paywall_translations_section',
	);
	...
	public function load_customizer() {
		...
		new Customizer\PenciPaywallOption( $this->customizer, 208 );
	}
}
