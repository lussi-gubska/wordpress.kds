...
class Api_Requestor {
	...
	private static function _specificAPIError( $rbody, $rcode, $rheaders, $resp, $errorData ) {
		...
		switch ( $rcode ) {
			...
			case 402:
				return Exception\Card_Exception::factory( $msg, $rcode, $rbody, $resp, $rheaders, $code, $declineCode, $param );
			case 403:
				return Exception\Permission_Exception::factory( $msg, $rcode, $rbody, $resp, $rheaders, $code );
			case 429:
				return Exception\RateLimit_Exception::factory( $msg, $rcode, $rbody, $resp, $rheaders, $code, $param );
			default:
