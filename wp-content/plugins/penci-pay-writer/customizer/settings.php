 ...
 */
class PenciPayWriterCustomizer {
	/**
	 * @var Customizer
	 */
	 ...
	 * @var string
	 */
	private static $package = 'PenciPayWriter';
	...
	private $list_section = array(
		'penci_pay_writer_general_section',
		'penci_pay_writer_posts_section'
	);
	...
	public function load_customizer() {
		...
		new Customizer\PenciPayWriterOption( $this->customizer, 209 );
	}
}
