...
class PenciPodcastCustomizer {
	...
	private $list_section = array(
		'penci_podcast_general_section',
		'penci_podcast_category_section',
		'penci_podcast_translate_section',
		'penci_podcast_series_section',
		'penci_podcast_colors_section'
	);
	...
	public function load_customizer() {
		...
		new Customizer\PenciPodCastOption( $this->customizer, 207 );
	}
}
