...
class ActionScheduler {
  ...
  public function setup() {
    ...
    add_action( PENCI_PODCAST_IMPORTER_ALIAS . '_scheduler_image_sync', [ $this, '_image_sync' ], 10, 2 );
    add_action( PENCI_PODCAST_IMPORTER_ALIAS . '_scheduler_images_md5_checksum', [ $this, '_images_md5_checksum' ], 10, 1 );
  }
  ...
  public function _action_scheduler_begin_execute() {
    ...
    foreach( $post_ids as $post_id )
      add_action( PENCI_PODCAST_IMPORTER_SCHEDULER_FEED_PREFIX . $post_id, [ $this, '_feed_sync' ], 10, 2 );
  ...
  public function _image_sync( $post_id, $image_path ) {
    ...
    $attachment_post_id = $wpdb->get_var(
      'SELECT post_id 
               FROM ' . $wpdb->postmeta . ' 
              WHERE meta_key = "pencipdc_attachment_md5"
    ...
    if( null === $attachment_post_id ) {
      ...
      update_post_meta( $attachment_post_id, 'pencipdc_attachment_md5', md5( $image_contents ) );
    } else {
  ...
  public function _images_md5_checksum( $attachment_ids ) {
    foreach( $attachment_ids as $attachment_id ) {
      ...
      update_post_meta( $attachment_id, 'pencipdc_attachment_md5', md5( $image_contents ) );
    }
  }
