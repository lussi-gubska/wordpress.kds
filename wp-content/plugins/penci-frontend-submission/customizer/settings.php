 ...
 */
class PenciFrontEndSubmissionCustomizer {
	/**
	 * @var Customizer
	 */
	 ...
	 * @var string
	 */
	private static $package = 'PenciFrontEndSubmission';
	...
	private $list_section = array(
		'penci_frontend_submission_general_section',
		'penci_frontend_submission_advanced_section',
		'penci_frontend_submission_translations_section'
	);
	...
	public function load_customizer() {
		...
		new Customizer\PenciFes_Option( $this->customizer, 206 );
	}
}
