...
function penci_soledad_addons_import_register() {
	$demo_listing = array(
		...
		'158-gaming-news'        => [ 'Gaming News', [ 'elementor' ] ],
		'159-video2'             => [ 'Video 2', [ 'elementor' ] ],
		'160-vnews'              => [ 'Video News', [ 'elementor' ] ],
		'161-beauty-world'       => [ 'Beauty World', [ 'elementor' ] ],
		'162-education-news2'    => [ 'Education News 2', [ 'elementor' ] ],
		'163-sport-news'         => [ 'Sport News', [ 'elementor' ] ],
		'164-diy-and-craft2'     => [ 'DIY & Craft 2', [ 'elementor' ] ],
		'165-automation-news'    => [ 'Automation News', [ 'elementor' ] ],
		'166-motorcycle-news'    => [ 'Motorcycle News', [ 'elementor' ] ],
		'167-real-estate-news'   => [ 'Real Estate News', [ 'elementor' ] ],
		
		'168-baking-recipes'     => [ 'Baking Recipes', [ 'elementor' ] ],
		'169-architecture-news'  => [ 'Architecture News', [ 'elementor' ] ],
		'170-classic-arch'       => [ 'Classic Architecture', [ 'elementor' ] ],
		'171-business-news'      => [ 'Business News', [ 'elementor' ] ],
		'172-finance-news'       => [ 'Finance News', [ 'elementor' ] ],
		'173-entertainment-news' => [ 'Entertainment News', [ 'elementor' ] ],
		'174-manga-news'         => [ 'Manga News', [ 'elementor' ] ],
		'175-animals-news'       => [ 'Animals News', [ 'elementor' ] ],
		'176-mothers-diary'      => [ 'Mothers Diary', [ 'elementor' ] ],
	);
...
if ( ! function_exists( 'penci_soledad_get_list_new_demo' ) ):
	function penci_soledad_get_list_new_demo() {
		$new_demo_listing = array(
			...
			'165-automation-news',
			'166-motorcycle-news',
			'167-real-estate-news',
			'168-baking-recipes',
			'169-architecture-news',
			'170-classic-arch',
			'171-business-news',
			'172-finance-news',
			'173-entertainment-news',
			'174-manga-news',
			'175-animals-news',
			'176-mothers-diary',
		);
