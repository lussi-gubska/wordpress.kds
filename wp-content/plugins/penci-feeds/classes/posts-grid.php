...
class PostsGrid {
    ...
    public function formatDateHelper( $date ) {
        $t_time = mysql2date( __( 'Y/m/d g:i:s A', 'penci-feeds' ), $date, true );
        $m_time = $date;
        ...
        if ( $time_diff > 0 && $time_diff < 24*60*60 )
            $h_time = sprintf( __( '%s ago', 'penci-feeds' ), human_time_diff( $time ) );
        else
            $h_time = mysql2date( __( 'Y/m/d', 'penci-feeds' ), $m_time );
    ...
    public function formatTimeHelper($date) {
        return sprintf( __( '%s ago', 'penci-feeds' ), human_time_diff( $date ) );
    }
    ...
    public function orderByHelper( $column, $bootstrap ) {
        ...
        return $bootstrap->menuUrl('pcfds-'.$bootstrap->currentPage, $bootstrap->currentAction, array('orderby'=>$orderBy, 'order'=>$order));
    }
