...
class Module extends Module_Base {
	...
	public function sticky_before_render( $section ) {
		...
		if ( ! empty( $settings['sticky_container_on'] ) == 'yes' ) {
			...
			// if ( ! empty( $settings['sticky_container_animation'] ) ) {
			// 	$section->add_render_attribute( '_wrapper', 'data-pencisctn-animation', $settings['sticky_container_animation'] );
			// }

			// if ( ! empty( $settings['sticky_container_position'] ) ) {
			// 	$section->add_render_attribute( '_wrapper', 'class', 'pencisctn-' . $settings['sticky_container_position'] );
			// }
